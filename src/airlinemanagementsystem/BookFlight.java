...
public class BookFlight extends JFrame implements ActionListener{
    ...
    JTextField tfaadhar;
    JLabel tfname, tfnationailty, tfaddress, labelgender, labelfname, labelfcode;
    JButton bookflight, fetchUser, flight;
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == fetchUser){
            ...
            String nationailty = tfnationailty.getText(); 
            ...
            String query = "insert into reservation values('PNR-"+random.nextInt(100000)+"', 'TIC-"+random.nextInt(10000)+"', '"+aadhar+"', '"+name+"', '"+nationailty+"', '"+flightname+"', '"+flightcode+"', '"+src+"', '"+dest+"', '"+ddate+"')";
